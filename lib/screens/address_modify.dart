...
class AddressModifyScreen extends StatefulWidget {
  ...
  _AddressModifyScreen createState() => _AddressModifyScreen();
}

class _AddressModifyScreen extends State<AddressModifyScreen> {
  ...
  addNewAddress() async {
    ...
    if (await Permission.locationWhenInUse.serviceStatus.isEnabled) {
      // Use location.
      AppRoutes.replace(context, LocationScreen(true));
    } else {
      showDisplayAllert(
          isSucces: false,
    ...
    // AppRoutes.replace(context, LocationScreen());
  }
